    ...
    <footer className="bg-teal-50 dark:bg-black/40 dark:border-t dark:border-white/10">
      <div className="mx-auto flex w-full max-w-7xl flex-col items-center justify-between px-12 py-16 md:flex-row">
        <div className="mb-8 space-y-4 text-center md:mb-0 md:text-left">
          <Link
            href="/"
            className="flex flex-col md:flex-row items-center md:items-center gap-2 md:gap-3 text-2xl font-bold tracking-tighter text-teal-900 dark:text-teal-50"
          >
            <Image src="/assets/logo.png" alt="Logo" width={65} height={65} />
            <span className="leading-none">Travel Guide</span>
          </Link>

          <p className="max-w-xs mx-auto md:mx-0 font-sans text-sm tracking-wide text-teal-900/50 dark:text-white/40">
            Elevating the art of travel through meticulous curation and storytelling.
          </p>
        </div>
        ...
        <div className="flex flex-col gap-6 md:items-end">
          ...
          <div className="font-sans text-sm tracking-wide text-teal-900/50 dark:text-white/30 text-center md:text-right">
            © {currentYear} The Trave Guide. All rights reserved.
          </div>
        </div>
      </div>
    </footer>
